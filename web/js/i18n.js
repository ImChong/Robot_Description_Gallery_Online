...
const STRINGS = {
  en: {
    ...
    'version.count': '{n} URDFs upstream — {shown} current, {old} deprecated',
    'version.one': 'One URDF upstream',
  ...
  zh: {
    ...
    'version.count': '上游共 {n} 个 URDF——{shown} 个在用，{old} 个已弃用',
    'version.one': '上游只有一个 URDF',
