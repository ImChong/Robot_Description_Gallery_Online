...
const STRINGS = {
  en: {
    ...
    'tree.hint': 'Hover a row to light that link up on the stage; click to keep it lit and jump to its slider.',
    'tree.root': 'root',
    ...
    'panel.resizeJoints': 'Joint slider panel width',
  ...
  zh: {
    ...
    'tree.hint': '悬停高亮舞台上对应的连杆；点击固定高亮，并跳到该关节的滑块。',
    'tree.root': '根连杆',
    'tree.noMesh': '本身没有几何体',
