...
在浏览器里加载 **94 个**开源机器人 URDF：拖关节、看碰撞体与惯量，一键下载 URDF、
网格 zip 或可直接 `colcon build` 的 ROS 2 功能包。

在线访问：<https://imchong.github.io/Robot_URDF_Gallery/>

人形 31 · 四足 18 · 机械臂 17 · 灵巧手 10 · 双臂 7 · 移动操作 7 · 双足 4
...
**English** — A browsable 3D gallery of 94 open robot descriptions (humanoids,
